    ...
    <Row>
      ...
      <Col span="24">
        ...
        <Table
          ...
          @on-select-cancel="CancelBatchDelete"
...
>>>>>>> d1598e88cb7ab5018aa83cb1235f1650ec18ea9d
              ...
              <Input
                v-model="CourseForm.BusinessGroup"
                placeholder="请输入"
                disabled
                style="width:200px"
              ></Input>
        ...
        <Row>
          ...
          <tables
            ...
            stripe
            height="200"
            @on-row-dblclick="dblclickUpDetail"
          />
      ...
      <div slot="footer">
        ...
        <button
          ...
          @click="handleReset('CourseForm');AddDepartment = false;"
        >
          <span>取消</span>
        </button>
        <button
    ...
    <Modal v-model="AddRoyalty" width="700" title="添加课程阶段信息" :mask-closable="false">
      ...
      <div slot="footer">
        ...
        <button
          type="button"
          class="ivu-btn ivu-btn-primary ivu-btn-large"
          @click="stagehandleSubmit('stageForm');"
        >
          <span>保存</span>
        </button>
      </div>
