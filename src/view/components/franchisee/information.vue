<template>
  <div id="information">
    ...
    <!-- 添加信息 弹出框-->
    <Modal v-model="AddDepartment" scrollable width="1100" title="添加加盟商信息" :mask-closable="false" :styles="{top: '20px'}">
      <Form
        ref="formValidate"
        :model="formValidate"
        :rules="ruleValidate"
    ...
    <!-- 修改信息 弹出框-->
    <Modal v-model="upDepartment" scrollable width="1100" title="查看加盟商信息" :mask-closable="false" :styles="{top: '20px'}">
